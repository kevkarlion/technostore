      ...
      <AnimatePresence>
        {isVisible && (
          <motion.div
            ...
            className="fixed inset-x-0 top-0 z-[70] border-b border-[var(--border-subtle)]/80 bg-[var(--background)]/95 backdrop-blur-xl"
          >
            <div className="w-full px-4 sm:px-6 lg:px-8">
              ...
              <div className="flex h-auto min-h-[3.5rem] flex-wrap content-center items-center gap-x-4 gap-y-2 py-2">
                ...
                {/* Search bar - más largo */}
                <div className="hidden lg:block flex-1 max-w-2xl mx-4">
                  <SearchBar className="w-full" />
                </div>

                {/* Redes Sociales + Carrito */}
                <div className="ml-auto hidden lg:flex items-center gap-3">
                  {/* Redes Sociales */}
                  <div className="flex items-center gap-2">
                    <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[var(--foreground-muted)] transition-colors hover:text-[#E4405F]">
                    ...
                    <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-[var(--foreground-muted)] transition-colors hover:text-[#1877F2]">
                      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                        <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                      </svg>
                    </a>
                    <a href="https://wa.me/5491112345678" target="_blank" rel="noopener noreferrer" className="text-[var(--foreground-muted)] transition-colors hover:text-[#25D366]">
                      <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
