 ...
 * Organized by parent category and subcategory
 * URLs: /category/{parent}/{subcategory}
 */
export const jotakpCategories: ScraperCategory[] = [
  // Almacenamiento (parent)
  ...
  // OUTLET (parent - sin subcategorías propias, es especial)
...
export function getScraperConfig(): ScraperConfig {
  ...
  return {
    ...
    delayMs: env.SUPPLIER_DELAY_MS || 3000,
